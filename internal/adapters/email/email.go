...
func NewEmailNotificationService(cfg MailConfig, logger logger.Logger) *EmailNotificationService {
	logger.Info("Email Service Address ...", cfg.FromEmail)
...
func (e *EmailNotificationService) SendMultiple(ctx context.Context, notifications []email.Notification) error {
...
func (e *EmailNotificationService) Send(ctx context.Context, notification *email.Notification) error {
